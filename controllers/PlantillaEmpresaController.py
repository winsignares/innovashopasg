...
@app.route('/empresa/cotizaciones/<int:id>', methods=['GET'])
def empresa_cotizaciones_ver(id):
    return render_template("empresa/empresa-cotizacion-ver.html", cot_id=id)
...
@app.route('/empresa/ordenes/<int:id>', methods=['GET'])
def empresa_ordenes_ver(id):
    return render_template("empresa/empresa-ordenes-ver.html", order_id=id)
# * Provedores
...
@app.route('/empresa/provedores/<int:id>', methods=['GET'])
def empresa_provedores_ver(id):
    return render_template("empresa/empresa-provedor-ver.html", provedor_id=id)
